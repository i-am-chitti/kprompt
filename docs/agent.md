...
**Durable proposals (RT-007):** `--autopilot-propose` persists proposals to file/ConfigMap (`kprompt-autopilot-proposals`). Inspect/apply later via `kprompt agent proposals list|show|apply --approve` without recompiling intent.
