...
Supported today: get/list, explain, investigate, why, timeline, impact, audit, cleanup, search, logs, describe, optimize. Unreachable contexts degrade; others still return.
