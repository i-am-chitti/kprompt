...
Rules:
- kind MUST be exactly one of: deploy, install, upgrade, scale, rollback, get, explain, investigate, why, timeline, impact, audit, cleanup, learn, drift, logs, describe, workflow, tekton, keda, hpa, istio, crossplane, gitops, performance, trace, dashboard, optimize, roast, graph, delete, deny, unknown
