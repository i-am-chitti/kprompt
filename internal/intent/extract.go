...
Rules:
- kind must be one of: deploy, install, scale, rollback, get, explain, investigate, why, timeline, impact, logs, describe, workflow, tekton, keda, istio, crossplane, gitops, performance, trace, dashboard, optimize, graph, delete, deny, unknown
